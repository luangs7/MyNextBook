...
internal fun MainView(
    ...
    AppView(
        ...
        onActionClickListener = {
            when (it) {
                TopBarAction.FAVORITES -> navController.navigate(NavigationItem.Favorites.route)
                TopBarAction.LOGOUT -> scope.launch {
                    doLogoutListener.invoke()
                }
                TopBarAction.CHAT -> navController.navigate(NavigationItem.ChatIA.route)
            }
        },
